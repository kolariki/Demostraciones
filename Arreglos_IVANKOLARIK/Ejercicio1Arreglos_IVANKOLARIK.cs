...
namespace Arreglos_IVANKOLARIK
{
    public partial class Ejercicio1Arreglos_IVANKOLARIK : Form
    {
        ...
        private void btnVerNotas2_Click(object sender, EventArgs e)
        {
            segundoAlumno();
        }

        private void btnVerNotas3_Click_1(object sender, EventArgs e)
        {
            tercerAlumno();
        }

        private void btnVerNotas4_Click(object sender, EventArgs e)
        {
            cuartoAlumno();
        }
